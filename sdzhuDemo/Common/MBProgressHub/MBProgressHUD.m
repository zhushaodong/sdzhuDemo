...
{
    return [MBProgressHUD showHUDAddedTo:view animated:NO];
}
...
+ (MBProgressHUD *)showHUDAddedTo:(UIView *)view lableText:(NSString *)lableText
{
    return [MBProgressHUD showHUDAddedTo:view lableText:lableText animated:NO];
}
